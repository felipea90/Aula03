...
public class EstruturaSwitch 
{
	public static void main(String[] args) 
	{
		...
		{
		case 1:
			System.out.println("Mas que bela interface você têm!");
			break;
		case 2:
			System.out.println("Bela protuberância nessa bacia!");
			break;
		case 3:
			System.out.println("Nenhum clone seu poderia ser melhor que você mesmo!");
			break;
		default:
