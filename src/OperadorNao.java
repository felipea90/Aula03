...
public class OperadorNao
{
	...
	public static void main(String[] args)
	{
		...
		/*Crie um programa que permita ou receba o tipo de um usuário em uma variável String e caso esse tipo NÃO SEJA "administrador", exibir a mensagem: "Atenção, usuário sem poderes administrativos. Algumas tarefas serão bloqueadas".*/
		...
		{
			System.out.println("Bem Vindo Sr. Stark");
		}
